...
//       // Initialize the user data in the mock Firebase environment
...
//       // Initialize the user pictures in the mock Firebase environment
//       final mockPicture1 = MockQueryDocumentSnapshot({
//         'url': 'https://example.com/picture1',
//         'id': 'picture1',
//         'latitude': 0.0,
//         'longitude': 0.0
//       }, data: {});
//       final mockPicture2 = MockQueryDocumentSnapshot({
...
//       when(mockQuerySnapshot.docs).thenReturn([mockPicture1, mockPicture2]);
//       when(mockCollectionReference.get())
//           .thenAnswer((_) async => mockQuerySnapshot);
...
//       final mockQueryDocumentSnapshot = MockQueryDocumentSnapshot(data: {'name': 'John Doe', 'age': 30});
//       when(mockQuerySnapshot.docs).thenReturn([
